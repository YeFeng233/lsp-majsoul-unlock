...
当前正式版本为 **0.7.2**，提供 **ARM64 版**和 **Universal 通用版**。安装包和更新元数据发布在 [GitHub Releases](https://github.com/YeFeng233/lsp-majsoul-unlock/releases/latest)，本次改动见 [0.7.2 更新日志](release-notes/v0.7.2.md)。
